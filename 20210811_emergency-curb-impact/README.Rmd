...
chart_cci + chart_rsi +
  plot_annotation(
    ...
    caption = str_c(
      "*July 2021 figure is an estimate\n",
      "Source: Bank Indonesia (BI); The Jakarta Post analysis\n",
...
chart_covid_mobitliy <- ggplot(mobility_covid, aes(cases_per_hundred_people, seven_day_average)) +
  geom_hline(yintercept = 0, color = "#E68F7E") +
  geom_point(
    pch = 21,
    fill = "#36A3D9",
...
chart_mobility_weighted + chart_covid_mobitliy +
  plot_annotation(
    title = "Movement trend falls before govt tightens restrictions as cases rise",
    subtitle = "Mobility to retail and recreation places* (percent)",
    caption = str_c(
      "*Change from January-February baseline smoothed to seven-day moving average **Weighted by population\n",
      "Source: Google; BPS; BNPB; The Jakarta Post analysis\n",
      "Chart: JP/Dzulfiqar Fathur Rahman"
    ),
    theme = theme_dfr()
  )
